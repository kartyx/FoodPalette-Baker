...
import com.foodpalette_baker.ProductsFragment.GetProducts;
...
public String[] productname,paymentamount,paymentdate;

	@Override
	public View onCreateView(LayoutInflater inflater,
			@Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		activityView = inflater.inflate(R.layout.activity_history_payment, container,false);
		fa=(FragmentActivity)getActivity();
		paymentHistoryList=(ListView)activityView.findViewById(R.id.paymenthistory);
	...
	public void parseResponse(String jsonResponse) {
		...
		HistoryPaymentAdapter adapter = new HistoryPaymentAdapter(fa,Items);	
